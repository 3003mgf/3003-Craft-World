    ...
    <motion.article className="h-screen fixed top-0 left-0 w-full flex items-center justify-center" onClick={()=> close(false)}>
      ...
      >
        <div className="flex items-center justify-center w-fit mx-auto">
          <div className="border-[4px] border-black/50 rounded-sm flex items-center max-w-xl w-[24rem] sm:w-[36rem] backdrop-blur-sm">
            <img src="/images/LoginModal.png" alt="Wallpaper" className="max-w-lg hidden sm:flex h-[23rem] lg:h-[28rem] rounded-sm object-contain border-r-[4px] border-black/50"/>
            <div className="flex-1 p-1 h-[23rem] lg:h-[28rem]">
              <div className="bg-black/50 w-full h-full flex items-center flex-col space-y-3 justify-center relative">
                <motion.button 
