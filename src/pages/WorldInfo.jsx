...
const WorldInfo = () => {
  return ( 
    <div className="bg-slate-400 h-screen max-h-screen w-full flex items-center justify-center relative bg-[url('https://nerdy-my-ecommerce.s3.us-east-2.amazonaws.com/wallpaper_dungeons_ultimate_edition_1920x1080.png')] bg-cover bg-center bg-no-repeat">
      ...
      <motion.div className="bg-black/80 mx-auto text-sm fonty w-[32rem] border-[6px] flex items-center justify-center flex-col border-black/20 rounded-sm backdrop-blur-sm px-3 py-6 text-white" {...slideAnimation("left")}>
          <h2 className="font-sans font-extrabold tracking-wide text-2xl mb-5">Welcome to 3003 World!</h2>
